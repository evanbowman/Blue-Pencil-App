package com.bp.moniljhaveri.thebackend;
        ...
        public void onClick(View view) {
            switch (view.getId()) {
               ...
               case (R.id.filter_button):
               {
                   ...
                   final int maxRes = 960;
                   int newWidth;
                   int newHeight;
                   int oldWidth = editBitmap.getWidth();
                   int oldHeight = editBitmap.getHeight();
                   if(oldWidth > oldHeight){
                       newWidth = maxRes;
                       newHeight = (oldHeight * maxRes) / oldWidth;
                   } else {
                       newHeight = maxRes;
                       newWidth = (oldWidth * maxRes) / oldHeight;
                   }

                   resizedEditBitmap = Bitmap.createScaledBitmap(editBitmap, newWidth, newHeight, false);
                   //___________________________________________________________
                   BW = ChangeGrey(resizedEditBitmap,2,1.0,1.0,0.0);
               ...
               case (R.id.invert_filter):
               {
                   ...
                   resizedEditBitmap = Bitmap.createScaledBitmap(editBitmap, newWidth, newHeight, false);
                   //___________________________________________________________
                   BW = InvertColor(resizedEditBitmap);
                   editImage.setImageBitmap(BW);
                   break;
               }
                case (R.id.sepia_filter):
                {
                    ...
                    resizedEditBitmap = Bitmap.createScaledBitmap(editBitmap, newWidth, newHeight, false);
                    //___________________________________________________________
                    BW = createSepiaToningEffect(resizedEditBitmap, 50, 1.5, 0.95, 0.12);
                    editImage.setImageBitmap(BW);
                    break;
                }
               case (R.id.green_filter):
               {
                ...
                case (R.id.blue_filter): {
                    ...
                    resizedEditBitmap = Bitmap.createScaledBitmap(editBitmap, newWidth, newHeight, false);
                    //___________________________________________________________
                    BW = Bluetrace(resizedEditBitmap);
                    editImage.setImageBitmap(BW);
                    break;
                }
